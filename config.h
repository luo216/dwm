...
static const Button buttons[] = {
    ...
    {ClkStatusText, 0, Button2, fifostatusbar, {.i = 2}},
    {ClkStatusText, 0, Button3, fifostatusbar, {.i = 3}},
    {ClkStatusText, 0, Button4, fifostatusbar, {.i = 4}},
    {ClkStatusText, 0, Button5, fifostatusbar, {.i = 5}},
