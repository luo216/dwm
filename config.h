...
static const int overviewgappi = 10; /* Gap size between window and edge during overview */
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask,            XK_l,      toggleoverview, {0}},
    {MODKEY | ShiftMask,            XK_d,      toggleoverview, {0}},
...
static const Button buttons[] = {
    ...
    {ClkWinTitle,      0,              Button3,      spawn,          {.v = termcmd_notab}},
